...
PI = 3.14159 # Constante, usar mayusculas

# id(edad) # Dirección de memoria
# type(edad) # Tipo de dato (entero, cadena, flotante, booleano...)
# id: edad
# tipo: entero
# valor: 25
...
print(len(cadena)) # Numero de caracteres que tiene la cadena
...
#######################################
    ...
    # cadena[start:]
    # cadena[start:end]
    # cadena[start:end:steps] # steps = saltos
...
# Lectura             Escritura
# diccionario[k1]      diccionario[k1] = valor
